...
<html>
	...
	<body>
		...
		<div>
			<?php
				$id = $_REQUEST['id'];
				$sql = "SELECT IF(CONCAT_WS(' ', FirstName, MiddleName, LastName)=' ', null, CONCAT_WS(' ', FirstName, MiddleName, LastName)) AS Name FROM Authors WHERE ID='$id'";
